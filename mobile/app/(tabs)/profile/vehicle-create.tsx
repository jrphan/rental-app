					...
					>
						<View className="bg-black/50" style={{ flex: 1, justifyContent: "flex-end" }}>
							...
							>
								...
								{/* City search + selectable list with highlight & check */}
								<View>
									<Input
										placeholder="Tìm thành phố..."
										value={form.watch("__tmp_city_search") || ""}
										onChangeText={(t) => form.setValue("__tmp_city_search", t)}
										style={{
											borderWidth: 1,
											borderColor: "#E5E7EB",
											borderRadius: 8,
									...
									<ScrollView style={{ maxHeight: 200 }}>
										{cities.length > 0 ? (
											cities
												...
												.map((c: any) => {
													const tmpCityJson = form.watch("__tmp_city");
													let selectedId: string | null = null;
													try {
														selectedId = tmpCityJson ? JSON.parse(tmpCityJson).id : null;
													} catch {
														selectedId = null;
													}
