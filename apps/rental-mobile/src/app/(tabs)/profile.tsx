...
export default function ProfileScreen() {
  ...
  const menuItems: MenuItem[] = [
    {
      ...
      screen: "/(subtabs)/vehicle_registration",
    },
    {
      icon: "heart-outline",
      label: "Xe yêu thích",
      screen: "/(subtabs)/favorite_vehicles",
    },
    {
      icon: "location-outline",
      label: "Địa chỉ của tôi",
      screen: "/(subtabs)/addresses",
    },
    {
      icon: "document-text-outline",
      label: "Giấy phép lái xe",
      screen: "/(subtabs)/kyc_documents",
    },
    {
      icon: "card-outline",
      label: "Thẻ thanh toán",
      screen: "/(subtabs)/payment_methods",
    },
  ...
  const otherItems: MenuItem[] = [
    ...
    // { icon: "share-social-outline", label: "Giới thiệu bạn mới" },
    {
      ...
      label: "Đổi mật khẩu",
      screen: "/(subtabs)/change_password",
    },
  ];
