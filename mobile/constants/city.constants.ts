 ...
 */
export const VIETNAM_CITIES: { label: string; value: string }[] = [
...
/**
 * Danh sách các thành phố phổ biến nhất (dùng cho HomeScreen)
 */
 ...
 */
export function getPopularCities(): { label: string; value: string }[] {
