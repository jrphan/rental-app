  ...
  useEffect(() => {
    ...
    const connectSocket = async () => {
      try {
        ...
        // Socket.IO client will connect to: baseUrl/notifications/socket.io/
        ...
        socket.on("notification", (notification: Notification) => {
          ...
          if (isVehicleNotification) {
            console.log(
              "Vehicle notification detected, invalidating vehicle queries"
            );
          ...
          if (isKycNotification) {
            console.log("KYC notification detected, invalidating user queries");
